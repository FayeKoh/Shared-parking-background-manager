<template>
  <div>
    ...
    <el-table style="width: 100%" border :data="list">
      ...
      <el-table-column prop="nickName" label="用户名称" width="width">
      </el-table-column>
      <el-table-column prop="incomeMoney" label="钱包余额" width="width">
      </el-table-column>
...
export default {
  ...
  methods: {
    async getPageList() {
      const { wadata } = this;
      let result = await this.$API.wallet.reqWalletList(wadata);
      if (result.code == 200) {
